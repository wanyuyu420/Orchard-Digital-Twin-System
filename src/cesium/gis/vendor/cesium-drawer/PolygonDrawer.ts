...
export default class PolygonDrawer {
  ...
  private _lastClickPosition: Cartesian2 = new Cesium.Cartesian2(
  ...
  private handleMouseLeftClick = (movement: EventArgs) => {
    ...
    if (
      ...
      Cesium.Cartesian2.magnitude(
        Cesium.Cartesian2.subtract(this._lastClickPosition, movement.position, {} as any)
      ) < this._mouseDelta
    )
      return
