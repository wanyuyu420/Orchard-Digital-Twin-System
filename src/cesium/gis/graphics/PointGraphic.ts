      ...
      case 'wifi':
        ...
        svgContent = `
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-6-8c.57 0 1.1-.17 1.55-.45l1.43 1.43c.45.28.98.45 1.55.45s1.1-.17 1.55-.45l1.43 1.43c.45.28.98.45 1.55.45s1.1-.17 1.55-.45l1.43 1.43c.18.11.39.17.6.17.67 0 1.22-.55 1.22-1.22s-.55-1.22-1.22-1.22c-.21 0-.42.06-.6.17l-1.43-1.43c-.45-.28-.98-.45-1.55-.45s-1.1.17-1.55.45l-1.43-1.43c-.45-.28-.98-.45-1.55-.45s-1.1.17-1.55.45l-1.43-1.43c-.18-.11-.39-.17-.6-.17-.67 0-1.22.55-1.22 1.22s.55 1.22 1.22 1.22c.21 0 .42-.06.6-.17L9 9.55c.45.28.98.45 1.55.45s1.1-.17 1.55-.45l1.43-1.43c.45-.28.98-.45 1.55-.45s1.1.17 1.55.45L6.45 11.55c-.45.28-.98.45-1.55.45z" fill="${fillColor}"/>
            <circle cx="12" cy="18" r="2" fill="${fillColor}"/>
            <path d="M12 6c-3.31 0-6 2.69-6 6h2c0-2.21 1.79-4 4-4s4 1.79 4 4h2c0-3.31-2.69-6-6-6z" fill="${fillColor}"/>
            
          </svg>`
         // Use a simpler geometric wifi icon for better visibility
         svgContent = `
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="${fillColor}" stroke="${strokeColor}" stroke-width="1">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" opacity="0.3"/>
            <path d="M12 6c3.07 0 6 1.44 7.8 3.8l-1.6 1.6C16.8 9.92 14.52 9 12 9c-2.52 0-4.8.92-6.2 2.4L4.2 9.8C6 7.44 8.93 6 12 6zm0 4c1.94 0 3.76.84 5 2.2l-1.6 1.6C14.57 13.1 13.34 12.6 12 12.6c-1.34 0-2.57.5-3.4 1.2l-1.6-1.6C8.24 10.84 10.06 10 12 10zm0 4c.69 0 1.3.26 1.77.69l-1.77 1.77-1.77-1.77c.47-.43 1.08-.69 1.77-.69z" />
          </svg>` 
        break
      case 'camera':
          // Camera style
