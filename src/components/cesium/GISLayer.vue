...
const currentTool = shallowRef<DrawTool | VolumeTool | FloodTool | ProfileTool | Measure3DTool | null>(null)
...
function activateMeasure3DTool(viewer: any) {
	...
	const tool = new Measure3DTool(viewer, {
		...
		onComplete: (result: Measure3DResult) => {
			...
			console.log(`Slope: ${result.slopeDistance.toFixed(2)}m, Horizontal: ${result.horizontalDistance.toFixed(2)}m`)
		},
