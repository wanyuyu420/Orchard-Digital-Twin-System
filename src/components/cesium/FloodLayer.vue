...
onUnmounted(() => {
  console.log('[FloodLayer] Component unmounting, cleaning up...')
  clearEntities()

  // Disable terrain when leaving flood visualization
  if (cesiumStore.terrainEnabled) {
    console.log('[FloodLayer] Disabling terrain on unmount')
    cesiumStore.disableTerrain()
  }

  // Clear simulation state
  simulationStore.setFloodArea(0)
})
