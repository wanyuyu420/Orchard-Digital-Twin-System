...
const analysisTools: Array<{ id: GISToolType; name: string; icon: string; tooltip: string; disabled?: boolean }> = [
	...
	{ id: 'profile', name: '剖面分析', icon: 'fa-solid fa-chart-line', tooltip: '剖面分析 - 绘制线获取地形剖面' },
	{ id: 'measure3d', name: '3D测量', icon: 'fa-solid fa-ruler-combined', tooltip: '3D测量 - Shift:地形 / Ctrl:自定义高度 / Alt:相对高度' },
]
