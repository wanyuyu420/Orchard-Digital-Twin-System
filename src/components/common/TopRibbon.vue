  ...
  <header class="top-ribbon">
    ...
    <div class="right-tools">
      ...
      <div class="tool-group">
        <button
          class="btn-icon-text"
          :class="{ active: gisStore.toolType === 'volume' }"
          @click="toggleAnalysisTool('volume')"
          title="方量分析"
        >
        ...
        <button
          class="btn-icon-text"
          :class="{ active: gisStore.toolType === 'flood' }"
          @click="toggleAnalysisTool('flood')"
          title="淹没分析"
        >
        ...
        <button
          class="btn-icon-text"
          :class="{ active: gisStore.toolType === 'profile' }"
          @click="toggleAnalysisTool('profile')"
          title="剖面分析"
        >
        ...
        <button
          class="btn-icon-text"
          :class="{ active: gisStore.toolType === 'measure3d' }"
          @click="toggleAnalysisTool('measure3d')"
          title="3D测量 (Shift:地形/Ctrl:自定义/Alt:相对)"
        >
      ...
      <div class="tool-group">
        <button
          class="btn-icon-text"
          :class="{ active: drawTool === 'point' }"
          @click="toggleDrawTool('point')"
          title="点标注"
        >
        ...
        <button
          class="btn-icon-text"
          :class="{ active: drawTool === 'polygon' }"
          @click="toggleDrawTool('polygon')"
          title="多边形"
        >
        ...
        <button
          ...
          @click="toggleDrawTool('rectangle')"
          title="矩形"
        >
      ...
      <div class="tool-group">
        ...
        <div class="btn-icon-wrapper">
          <button
            class="btn-icon"
            @click="toggleMapPanel"
            :class="{ active: isMapPanelVisible }"
            title="底图控制"
          >
